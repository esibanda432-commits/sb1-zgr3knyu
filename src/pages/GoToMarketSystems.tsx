    ...
    <div className="pt-[76px]">
            ...
            <div key={layer.number} className="relative pb-16">
              <div className="panel relative p-7 sm:p-10">
                <div className="flex items-start justify-between gap-5">
                  ...
                  <span className="text-3xl font-bold text-[#27394d]">{layer.number}</span>
                </div>
                ...
                {i === 0 && (
                  <p className="mt-8 text-sm text-[#6bb7ff]">We cover every channel so your ideal client doesn't miss you.</p>
                )}

                {i === 2 && (
                  <div className="mt-10 overflow-hidden rounded-xl border border-white/[.1] bg-[#0b0d12] shadow-[0_0_50px_rgba(30,144,255,.12)]">
                    ...
                    <div className="grid gap-4 p-5 sm:grid-cols-3">
                      ...
                      <div className="h-28 rounded-lg bg-[#141923] p-4">
                        ...
                        <p className="mt-4 text-2xl font-semibold text-[#6bb7ff]">48</p>
                      </div>
                      <div className="h-28 rounded-lg bg-[#141923] p-4">
                    ...
                    <div className="mx-5 mb-5 h-24 rounded-lg bg-gradient-to-t from-[#15304b] to-transparent p-4">
                      <div className="flex h-full items-end gap-2">
                        {chartBars.map((h, j) => (
                          <div key={j} className="flex-1 rounded-t bg-[#1e90ff] opacity-80" style={{ height: `${h}%` }} />
                        ))}
                      </div>
                    </div>
                  </div>
              ...
              {i < 2 && (
                <div className="absolute bottom-0 left-1/2 z-10 grid h-10 w-10 -translate-x-1/2 translate-y-1/2 place-items-center rounded-full border border-[#1e90ff]/40 bg-[#0a0b0f] text-[#6bb7ff]">
                  <ArrowDown size={17} />
                </div>
              )}
            </div>
      ...
      <section className="container pb-24 text-center">
        <div className="mx-auto max-w-xl">
          ...
          <a href="#contact" className="button-primary mt-8">Talk with our team <ArrowRight size={17} /></a>
        </div>
      </section>
    </div>
  );
