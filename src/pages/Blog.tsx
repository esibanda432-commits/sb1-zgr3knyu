...
export default function Blog({ navigate }: Props) {
  ...
  return (
    <div className="pt-[88px]">
      ...
      <section className="container grid gap-5 pb-28 md:grid-cols-2 lg:grid-cols-3">
        {filtered.map(post => (
          <article key={post.slug} className="panel group overflow-hidden">
            <div className="h-48 bg-gradient-to-br from-[#102838] via-[#101923] to-[#1a1d25] p-6">
            ...
            <div className="p-7">
              <div className="flex items-center gap-3 text-xs muted">
                <span>{post.date}</span>
                <span className="h-1 w-1 rounded-full bg-[#596271]" />
